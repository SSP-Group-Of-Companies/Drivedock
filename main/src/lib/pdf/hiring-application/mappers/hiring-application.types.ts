...
export enum EDriverApplicationFillableFormFields {
  ...
  /* =========================
   * Page 4 - Employment Record (Current + up to 7 previous)
   * ========================= */
  // Current
  ...
  CURRENT_EMPLOYER_STATE = "current_employer_state",
  ...
  CURRENT_POSITION_HELD = "current_position_held",
  ...
  PREV_EMPLOYER_1_STATE = "prev_employer_1_state",
  PREV_EMPLOYER_1_PHONE_1 = "prev_employer_1_phone_1",
  PREV_EMPLOYER_1_PHONE_2 = "prev_employer_1_phone_2",
  PREV_EMPLOYER_1_EMAIL = "prev_employer_1_email",
  PREV_1_POSITION_HELD = "prev_1_position_held",
  ...
  PREV_2_POSITION_HELD = "prev_2_position_held",
  ...
  PREV_3_POSITION_FROM = "prev_3_position_from",
  PREV_3_POSITION_TO = "prev_3_position_to",
  ...
  // Prev 4
  PREV_EMPLOYER_4_NAME = "prev_employer_4_name",
  PREV_EMPLOYER_4_SUPERVISOR_NAME = "prev_employer_4_supervisor_name",
  PREV_EMPLOYER_4_ADDRESS = "prev_employer_4_address",
  PREV_EMPLOYER_4_CITY = "prev_employer_4_city",
  PREV_EMPLOYER_4_POSTAL_CODE = "prev_employer_4_postal_code",
  PREV_EMPLOYER_4_STATE = "prev_employer_4_state",
  PREV_EMPLOYER_4_PHONE_1 = "prev_employer_4_phone_1",
  PREV_EMPLOYER_4_PHONE_2 = "prev_employer_4_phone_2",
  PREV_EMPLOYER_4_EMAIL = "prev_employer_4_email",
  PREV_4_POSITION_HELD = "prev_4_position_held",
  PREV_4_POSITION_FROM = "prev_4_position_from",
  PREV_4_POSITION_TO = "prev_4_position_to",
  PREV_4_SALARY = "prev_4_salary",
  PREV_4_REASON_FOR_LEAVING = "prev_4_reason_for_leaving",
  PREV_4_FMCSR_YES = "prev_4_fmcsr_yes",
  PREV_4_FMCSR_NO = "prev_4_fmcsr_no",
  PREV_4_DOT_SENSITIVE_YES = "prev_4_dot_sensitive_yes",
  PREV_4_DOT_SENSITIVE_NO = "prev_4_dot_sensitive_no",

  // Prev 5
  PREV_EMPLOYER_5_NAME = "prev_employer_5_name",
  PREV_EMPLOYER_5_SUPERVISOR_NAME = "prev_employer_5_supervisor_name",
  PREV_EMPLOYER_5_ADDRESS = "prev_employer_5_address",
  PREV_EMPLOYER_5_CITY = "prev_employer_5_city",
  PREV_EMPLOYER_5_POSTAL_CODE = "prev_employer_5_postal_code",
  PREV_EMPLOYER_5_STATE = "prev_employer_5_state",
  PREV_EMPLOYER_5_PHONE_1 = "prev_employer_5_phone_1",
  PREV_EMPLOYER_5_PHONE_2 = "prev_employer_5_phone_2",
  PREV_EMPLOYER_5_EMAIL = "prev_employer_5_email",
  PREV_5_POSITION_HELD = "prev_5_position_held",
  PREV_5_POSITION_FROM = "prev_5_position_from",
  PREV_5_POSITION_TO = "prev_5_position_to",
  PREV_5_SALARY = "prev_5_salary",
  PREV_5_REASON_FOR_LEAVING = "prev_5_reason_for_leaving",
  PREV_5_FMCSR_YES = "prev_5_fmcsr_yes",
  PREV_5_FMCSR_NO = "prev_5_fmcsr_no",
  PREV_5_DOT_SENSITIVE_YES = "prev_5_dot_sensitive_yes",
  PREV_5_DOT_SENSITIVE_NO = "prev_5_dot_sensitive_no",

  // Prev 6
  PREV_EMPLOYER_6_NAME = "prev_employer_6_name",
  PREV_EMPLOYER_6_SUPERVISOR_NAME = "prev_employer_6_supervisor_name",
  PREV_EMPLOYER_6_ADDRESS = "prev_employer_6_address",
  PREV_EMPLOYER_6_CITY = "prev_employer_6_city",
  PREV_EMPLOYER_6_POSTAL_CODE = "prev_employer_6_postal_code",
  PREV_EMPLOYER_6_STATE = "prev_employer_6_state",
  PREV_EMPLOYER_6_PHONE_1 = "prev_employer_6_phone_1",
  PREV_EMPLOYER_6_PHONE_2 = "prev_employer_6_phone_2",
  PREV_EMPLOYER_6_EMAIL = "prev_employer_6_email",
  PREV_6_POSITION_HELD = "prev_6_position_held",
  PREV_6_POSITION_FROM = "prev_6_position_from",
  PREV_6_POSITION_TO = "prev_6_position_to",
  PREV_6_SALARY = "prev_6_salary",
  PREV_6_REASON_FOR_LEAVING = "prev_6_reason_for_leaving",
  PREV_6_FMCSR_YES = "prev_6_fmcsr_yes",
  PREV_6_FMCSR_NO = "prev_6_fmcsr_no",
  PREV_6_DOT_SENSITIVE_YES = "prev_6_dot_sensitive_yes",
  PREV_6_DOT_SENSITIVE_NO = "prev_6_dot_sensitive_no",

  // Prev 7
  PREV_EMPLOYER_7_NAME = "prev_employer_7_name",
  PREV_EMPLOYER_7_SUPERVISOR_NAME = "prev_employer_7_supervisor_name",
  PREV_EMPLOYER_7_ADDRESS = "prev_employer_7_address",
  PREV_EMPLOYER_7_CITY = "prev_employer_7_city",
  PREV_EMPLOYER_7_POSTAL_CODE = "prev_employer_7_postal_code",
  PREV_EMPLOYER_7_STATE = "prev_employer_7_state",
  PREV_EMPLOYER_7_PHONE_1 = "prev_employer_7_phone_1",
  PREV_EMPLOYER_7_PHONE_2 = "prev_employer_7_phone_2",
  PREV_EMPLOYER_7_EMAIL = "prev_employer_7_email",
  PREV_7_POSITION_HELD = "prev_7_position_held",
  PREV_7_POSITION_FROM = "prev_7_position_from",
  PREV_7_POSITION_TO = "prev_7_position_to",
  PREV_7_SALARY = "prev_7_salary",
  PREV_7_REASON_FOR_LEAVING = "prev_7_reason_for_leaving",
  PREV_7_FMCSR_YES = "prev_7_fmcsr_yes",
  PREV_7_FMCSR_NO = "prev_7_fmcsr_no",
  PREV_7_DOT_SENSITIVE_YES = "prev_7_dot_sensitive_yes",
  PREV_7_DOT_SENSITIVE_NO = "prev_7_dot_sensitive_no",
