export enum EDriverApplicationFillableFormFields {
  ...
  PROCESS_APPLICANT_HIRED_YE = "process_applicant_hired_ye",
  ...
  CURRENT_ADDRESS_FROM = "current_address_from",
  CURRENT_ADDRESS_TO = "current_address_to",
  ...
  PREVIOUS_ADDRESS_1_FROM = "previous_address_1_from",
  PREVIOUS_ADDRESS_1_TO = "previous_address_1_to",
  ...
  PREVIOUS_ADDRESS_2_FROM = "previous_address_2_from",
  PREVIOUS_ADDRESS_2_TO = "previous_address_2_to",
  HOME_PHONE = "home_phone",
  CELL_PHONE = "cell_phone",
  EMAIL = "email",
  EMERGENCY_CONTACT_NAME = "emergency_contact_name",
  EMERGENCY_CONTACT_PHONE = "emergency_contact_phone",
  WORKWCOMP_PREV_FROM = "workwcomp_prev_from",
  WORKWCOMP_PREV_TO = "workwcomp_prev_to",
  ...
  CURRENT_EMPLOYER_SATE = "current_employer_sate",
  ...
  COMP_ACK_CONTRACTOR_NAME = "comp_ack_contractor_name",
  COMP_ACK_CONTRACTOR_NAME_REPEAT = "comp_ack_contractor_name_repeat",
  COMP_ACK_CONTRACTOR_NAME_FINAL = "comp_ack_contractor_name_final",
 ...
 * ----------------------------------------------------------------------
 * Field names are grouped by PDF page/section for clarity.
 * DO NOT change the identifiers — they must match the PDF template.
 * ======================================================================
 */

export enum EDriverApplicationFillableFormFields2 {
  /* =========================
  ...
  DL_EXPIRY = "dl_expiry",
  LICENSE_ISSUE_PROVINCE = "license_Issue_province",
  SIN_ISSUE_DATE = "sin_issue_date", // skipped per business rule
  FORM_DATE = "form_date",
  DOB = "dob",
  ...
  /* =========================
   * Page 4 - Employment Record (up to 4)
   * ========================= */
  CURRENT_EMPLOYER_NAME = "current_employer_name",
  CURRENT_SUPERVISOR_NAME = "current_supervisor_name",
  CURRENT_EMPLOYER_ADDRESS = "current_employer_address",
  ...
  /* =========================
   * Page 5 - Accidents, Education, Licenses, HOS
   * ========================= */
  ACCIDENT_1_DATE = "accident_1_date",
  ACCIDENT_1_NATURE = "accident_1_nature",
  ACCIDENT_1_FATALITIES = "accident_1_fatalities",
  ...
  /* =========================
   * Page 10 - Alcohol & Drug Receipt + Trailer Seal Procedure
   * ========================= */
  DRUG_RECEIPT_DRIVER_NAME = "drug_receipt_driver_name",
  DRUG_RECEIPT_SIGNATURE = "drug_receipt_signature",
  DRUG_RECEIPT_DATE_DAY = "drug_receipt_date_day",
  ...
  /* =========================
   * Page 11 - Pre-Employment Competency Test
   * ========================= */
  COMPETENCY_Q1_A = "competency_q1_a",
  COMPETENCY_Q1_B = "competency_q1_b",
  COMPETENCY_Q1_C = "competency_q1_c",
...
(function compareEnums() {
  const enum1Keys = Object.values(EDriverApplicationFillableFormFields);
  const enum2Keys = Object.values(EDriverApplicationFillableFormFields2);

  const missingIn2 = enum1Keys.filter((key) => !enum2Keys.includes(key as any));
  const missingIn1 = enum2Keys.filter((key) => !enum1Keys.includes(key as any));

  console.log("=== Enum Comparison Report ===");
  console.log("Total in Enum1:", enum1Keys.length);
  console.log("Total in Enum2:", enum2Keys.length);

  if (missingIn2.length === 0 && missingIn1.length === 0) {
    console.log("✅ Both enums have exactly the same fields.");
  } else {
    if (missingIn2.length > 0) {
      console.log("❌ Missing in Enum2:", missingIn2);
    }
    if (missingIn1.length > 0) {
      console.log("❌ Missing in Enum1:", missingIn1);
    }
  }
})();
