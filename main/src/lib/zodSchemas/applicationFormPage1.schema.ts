...
export const applicationFormPage1Schema = z
  .object({
  ...
  .refine((data) => data.phoneCell !== data.emergencyContactPhone, {
    message: "Cell phone and emergency contact phone cannot be the same",
    path: ["emergencyContactPhone"], // show error under emergencyContactPhone
  });
