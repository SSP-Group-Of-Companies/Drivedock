...
export default function AddressHistorySection({ data, isEditMode, staged, onStage }: AddressHistorySectionProps) {
  ...
  const getFieldErrors = (addressIndex: number, field: string): AddressValidationError[] => {
    return validationErrors.filter(error => 
      error.addressIndex === addressIndex && error.field === field
    );
  };
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 pb-2 border-b" style={{ borderColor: "var(--color-outline-variant)" }}>
          <div className="w-2 h-8 rounded-full" style={{ background: "var(--color-info)" }}></div>
          <h3 className="text-xl font-bold" style={{ color: "var(--color-on-surface)" }}>Address History</h3>
        </div>
                ...
                {isEditMode ? (
                  <div className="space-y-1">
                    <input
                      ...
                      style={{
                        background: "var(--color-surface)",
                        borderColor: getFieldErrors(index, 'address').length > 0 ? "var(--color-error)" : "var(--color-outline)",
                ...
                {isEditMode ? (
                  <div className="space-y-1">
                    <input
                      ...
                      style={{
                        background: "var(--color-surface)",
                        borderColor: getFieldErrors(index, 'city').length > 0 ? "var(--color-error)" : "var(--color-outline)",
                        color: "var(--color-on-surface)",
                      }}
                ...
                {isEditMode ? (
                  <div className="space-y-1">
                    <input
                      ...
                      style={{
                        background: "var(--color-surface)",
                        borderColor: getFieldErrors(index, 'stateOrProvince').length > 0 ? "var(--color-error)" : "var(--color-outline)",
                        color: "var(--color-on-surface)",
                      }}
                ...
                {isEditMode ? (
                  <div className="space-y-1">
                    <input
                      ...
                      style={{
                        background: "var(--color-surface)",
                        borderColor: getFieldErrors(index, 'postalCode').length > 0 ? "var(--color-error)" : "var(--color-outline)",
                        color: "var(--color-on-surface)",
                      }}
                ...
                {isEditMode ? (
                  <div className="space-y-1">
                    <input
                      ...
                      style={{
                        background: "var(--color-surface)",
                        borderColor: getFieldErrors(index, 'from').length > 0 ? "var(--color-error)" : "var(--color-outline)",
                        color: "var(--color-on-surface)",
                      }}
                    />
                ...
                {isEditMode ? (
                  <div className="space-y-1">
                    <input
                      ...
                      style={{
                        background: "var(--color-surface)",
                        borderColor: getFieldErrors(index, 'to').length > 0 ? "var(--color-error)" : "var(--color-outline)",
                        color: "var(--color-on-surface)",
                      }}
                    />
