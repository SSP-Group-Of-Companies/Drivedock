...
export default function AccidentReportSection({ data, onStage }: AccidentReportSectionProps) {
  ...
  const addAccident = () => {
    const newAccident: IAccidentEntry = {
      date: "",
      natureOfAccident: "",
      fatalities: 0,
      injuries: 0,
              ...
              {isEditMode ? (
                <>
                  ...
                  <input
                    ...
                    onChange={(e) => updateAccident(index, "fatalities", parseInt(e.target.value) || 0)}
                    min="0"
                    className="py-2 px-3 rounded-md border focus:ring-2 focus:outline-none transition-colors"
                    style={{
                      background: "var(--color-surface)",
                  ...
                  <input
                    ...
                    onChange={(e) => updateAccident(index, "injuries", parseInt(e.target.value) || 0)}
                    min="0"
                    className="py-2 px-3 rounded-md border focus:ring-2 focus:outline-none transition-colors"
                    style={{
                      background: "var(--color-surface)",
