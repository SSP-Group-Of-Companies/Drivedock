...
export default function DashboardSkeleton({ variant = "home", showSidebar = true }: DashboardSkeletonProps) {
      ...
      <div className="flex min-h-0 flex-1">
        ...
        {showSidebar && (
          <div className="hidden xl:block shrink-0 w-56 lg:w-64">
            <div className="h-full pl-3 pr-0 py-4" style={{ backgroundColor: "var(--color-card)" }}>
              <div className="space-y-4">
                {/* Navigation section */}
                <div>
                  <motion.div className="h-3 w-20 bg-gray-200 dark:bg-gray-700 rounded mb-2" animate={{ opacity: [0.6, 1, 0.6] }} transition={{ duration: 1.5, repeat: Infinity }} />
        ...
        <main className="min-w-0 flex-1" style={{ backgroundColor: "var(--color-surface)" }}>
          <div className="mx-auto w-full max-w-screen-2xl px-3 sm:px-4 md:px-6 lg:px-8 pt-4 pb-8">
            {/* Page Header */}
            <div className="mb-6">
              <motion.div className="h-8 w-48 bg-gray-200 dark:bg-gray-700 rounded mb-2" animate={{ opacity: [0.6, 1, 0.6] }} transition={{ duration: 1.5, repeat: Infinity }} />
              <motion.div className="h-4 w-64 bg-gray-200 dark:bg-gray-700 rounded" animate={{ opacity: [0.6, 1, 0.6] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.2 }} />
            </div>
            ...
            {isContract ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-200 dark:bg-gray-700 rounded-lg p-4">
                  <motion.div className="h-6 w-32 bg-gray-300 dark:bg-gray-600 rounded mb-4" animate={{ opacity: [0.6, 1, 0.6] }} transition={{ duration: 1.5, repeat: Infinity }} />
