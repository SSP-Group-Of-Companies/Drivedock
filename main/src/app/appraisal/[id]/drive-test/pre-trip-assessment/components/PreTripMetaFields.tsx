    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select {...register("preTrip.expectedStandard")} disabled={isLocked} aria-invalid={!!expectedStandardErr} className={withErrorRing(selectBase, !!expectedStandardErr)}>
        ...
        <div>
          ...
          <select {...register("preTrip.overallAssessment")} disabled={isLocked} aria-invalid={!!overallAssessmentErr} className={withErrorRing(selectBase, !!overallAssessmentErr)}>
