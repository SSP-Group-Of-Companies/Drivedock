...
export default function OnRoadFailConfirmModal({ open, onCancel, onConfirm }: Props) {
  return (
    <AnimatePresence>
      {open && (
              ...
              <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 30, opacity: 0 }} transition={{ duration: 0.2 }}>
                <div className="p-6">
                  ...
                  <Description className="text-sm text-gray-700">
                    You selected <strong>Fail</strong> for the On-Road Assessment. Proceeding will
