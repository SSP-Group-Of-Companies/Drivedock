    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select {...register("onRoad.expectedStandard")} disabled={isLocked} aria-invalid={!!expectedStandardErr} className={withError(selectBase, !!expectedStandardErr)}>
        ...
        <div>
          ...
          <select {...register("onRoad.overallAssessment")} disabled={isLocked} aria-invalid={!!overallAssessmentErr} className={withError(selectBase, !!overallAssessmentErr)}>
