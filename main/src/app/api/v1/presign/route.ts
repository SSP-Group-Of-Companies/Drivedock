...
const FOLDER_ALLOWED_MIME: Record<ES3Folder, readonly EFileMimeType[]> = {
  ...
  [ES3Folder.LICENSES]: IMAGES_AND_DOCS,
  [ES3Folder.HEALTH_CARD_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.PASSPORT_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.PR_CITIZENSHIP_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.INCORPORATION_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.HST_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.BANKING_INFO_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.US_VISA_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.SIN_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.MEDICAL_CERT_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.FAST_CARD_PHOTOS]: IMAGES_AND_DOCS,
  [ES3Folder.DRIVE_TEST]: IMAGES_AND_DOCS,
};
