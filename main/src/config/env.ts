...
export const NEXT_IMAGE_EXTRA_DOMAINS = process.env.NEXT_IMAGE_EXTRA_DOMAINS!;
export const NEXT_IMAGE_REMOTE_PATTERNS = process.env.NEXT_IMAGE_REMOTE_PATTERNS!;
